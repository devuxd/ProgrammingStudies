...
//.................................................................................
// When a user first hits the study server, first check if they have already
// participated. If not, send them to the screening test.
//.................................................................................
app.get('/screeningTask', function (req, res) {
    ...
    workerRef.once('value', function(snapshot) {
        if (snapshot.val() == null)
        {
            ...
            // We could also then use templating to set up worker specific content in
            // the templates.Like customizing the instructions. Or hiding or showing
            // the chat system for different versions.

            res.sendFile(__dirname + '/client/screening.html');///?workerId=5');
            // ?workerId=' + workerId);
        }
        else
        {
...
//.................................................................................
// After finishing the screening, check if they passed. If so, send them to the
// demographics page.
//.................................................................................
...
function firebaseSetup()
{
    ...
    // Watch for additions to the waitingList. Once the waiting list meets or
    // exceeds the size of the number of participants required for the nextSession,
    // start the session.
...
//.................................................................................
// Create the workflows on Firebase and the corresponding initial sessions for each
//workflow.
//.................................................................................
function createWorkflows()
{
    ...
    // Create a JSON object for each workflow and a corresponding first session for
    // each workflow
    ...
    // Create the initial status, setting up the first session and the current total
    // number of sessions.
    var status = {};
...
function startSession(session, waitlistSnapshot)
{
    ...
    statusRef.once("value", function(snapshot)
    {
        if (snapshot.val() != null)
        {
            ...
            // Build the list of IDs for the workers who will be working on this
            // ession.
            var workers = {};
            var i = 0;
            ...
            // Set the sessionURL for each of the first totalParticipants workers
            // on the waitlist. Setting this URL will cause each of these worker
            // clients that are currently waiting to join the session.
